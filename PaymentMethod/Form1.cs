namespace PaymentMethod
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            rdButtonCash.CheckedChanged += RadioButton_CheckedChanged;
        ...
        private void RadioButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (selectedRadioButton.Checked)
            {
                ...
                else if (selectedRadioButton == rdButtonCash)
                {
                    rdButtonMasterCard.Checked = false;
                    rdButtonVisa.Checked = false;
                }
            }
            if (selectedRadioButton == rdButtonCash && rdButtonCash.Checked)
            {
        ...
        {
            //code para bumalik sa menu form, di ko pa alam name kasi
            //this.Visible = false;
            //Menu menu = new Menu();
            //menu.Show();
        }
